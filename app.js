...
function renderMobileManagerServiceDateCard() {
  return `
    <section class="mobile-manager-card mobile-manager-service-date">
      <details id="mobileManagerServiceDateDetails" class="mobile-manager-details">
        <summary>
          <div>
            <h2>Change Service Date</h2>
            <p>Current: ${esc(state.activeDate)}</p>
          </div>
